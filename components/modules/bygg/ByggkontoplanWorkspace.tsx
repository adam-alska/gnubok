...
const DEFAULT_ACCOUNTS: Account[] = [
  { number: '3010', name: 'Entreprenadintäkter', type: 'Intäkt', category: 'Projektintäkt' },
  { number: '3011', name: 'ÄTA-intäkter', type: 'Intäkt', category: 'ÄTA' },
  { number: '3080', name: 'Fakturerad ej upparbetad intäkt', type: 'Intäkt', category: 'PIA' },
  { number: '4010', name: 'Materialinköp', type: 'Kostnad', category: 'Material' },
  { number: '4400', name: 'Underentreprenörer (UE)', type: 'Kostnad', category: 'Underentreprenör' },
  { number: '4410', name: 'UE mark & grund', type: 'Kostnad', category: 'Underentreprenör' },
  { number: '4420', name: 'UE el', type: 'Kostnad', category: 'Underentreprenör' },
  { number: '4430', name: 'UE VVS', type: 'Kostnad', category: 'Underentreprenör' },
  { number: '4500', name: 'Maskinhyra', type: 'Kostnad', category: 'Maskiner' },
  { number: '1470', name: 'Pågående arbete (PIA)', type: 'Tillgång', category: 'PIA' },
  { number: '1471', name: 'Upparbetad ej fakturerad intäkt', type: 'Tillgång', category: 'PIA' },
  { number: '7010', name: 'Löner byggpersonal', type: 'Kostnad', category: 'Personal' },
  ...
  { number: '2440', name: 'Leverantörsskulder UE', type: 'Skuld', category: 'Underentreprenör' },
]
...
export function ByggkontoplanWorkspace({ module: mod, sectorSlug, settingsHref }: ModuleWorkspaceProps) {
  ...
  async function handleSaveAccount() {
    const newAccount: Account = {
      ...
      project: accountForm.project.trim() || undefined,
    }
              ...
              <EmptyModuleState
                ...
                description={
                  searchQuery || filterType !== 'all'
                    ...
                    : 'Lägg till konton för att bygga upp din byggkontoplan.'
                }
      ...
      <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
        <DialogContent className="max-w-md">
          <DialogHeader>
            ...
            <DialogDescription>
              {editingAccount
                ...
                : 'Fyll i uppgifterna för det nya kontot. UE-konton (4400-serien) spårar underentreprenörskostnader.'}
            </DialogDescription>
          </DialogHeader>
          <div className="grid gap-4 py-2">
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="grid gap-2">
                ...
                <Input
                  ...
                  placeholder="Underentreprenörer"
                />
              </div>
            </div>
            <div className="grid grid-cols-2 gap-4">
            ...
            <div className="grid gap-2">
              <Label htmlFor="acct-project">Projektkoppling (valfritt)</Label>
              <Input
                id="acct-project"
                value={accountForm.project}
                onChange={(e) => setAccountForm((f) => ({ ...f, project: e.target.value }))}
                placeholder="t.ex. Projekt 2024-001"
              />
            </div>
          </div>
          <DialogFooter>
