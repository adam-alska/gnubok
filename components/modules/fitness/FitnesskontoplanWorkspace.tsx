...
type AccountCategory = 'Medlemskap' | 'PT' | 'Klippkort' | 'Butik' | 'Personal' | 'Lokal' | 'Övrigt'
...
const ACCOUNT_CATEGORIES: AccountCategory[] = ['Medlemskap', 'PT', 'Klippkort', 'Butik', 'Personal', 'Lokal', 'Övrigt']

const DEFAULT_ACCOUNTS: Account[] = [
  { number: '3010', name: 'Medlemsavgifter', type: 'Intäkt', category: 'Medlemskap' },
  { number: '3020', name: 'PT-intäkter', type: 'Intäkt', category: 'PT' },
  { number: '3030', name: 'Butik/tillbehör', type: 'Intäkt', category: 'Butik' },
  { number: '3040', name: 'Drop-in', type: 'Intäkt', category: 'Medlemskap' },
  { number: '2420', name: 'Klippkort (förutbetald intäkt)', type: 'Skuld', category: 'Klippkort' },
  { number: '4010', name: 'Inköp kosttillskott/butik', type: 'Kostnad', category: 'Butik' },
  { number: '5010', name: 'Lokalhyra', type: 'Kostnad', category: 'Lokal' },
  { number: '5020', name: 'Utrustning & underhåll', type: 'Kostnad', category: 'Lokal' },
...
export function FitnesskontoplanWorkspace({ module: mod, sectorSlug, settingsHref }: ModuleWorkspaceProps) {
          ...
          <div className="grid gap-4 py-2">
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="grid gap-2">
                ...
                <Input id="acct-name" value={accountForm.name} onChange={(e) => setAccountForm((f) => ({ ...f, name: e.target.value }))} placeholder="Medlemsavgifter" />
              </div>
            </div>
            <div className="grid grid-cols-2 gap-4">
              <div className="grid gap-2">
