...
type AccountCategory = 'Kommunal peng' | 'Föräldraavgift' | 'Statsbidrag' | 'Personal' | 'Lokaler' | 'Material' | 'Kost' | 'Övrigt'
...
const ACCOUNT_CATEGORIES: AccountCategory[] = ['Kommunal peng', 'Föräldraavgift', 'Statsbidrag', 'Personal', 'Lokaler', 'Material', 'Kost', 'Övrigt']

const DEFAULT_ACCOUNTS: Account[] = [
  { number: '3010', name: 'Kommunal peng', type: 'Intäkt', category: 'Kommunal peng' },
  { number: '3020', name: 'Föräldraavgifter', type: 'Intäkt', category: 'Föräldraavgift' },
  { number: '3910', name: 'Statsbidrag', type: 'Intäkt', category: 'Statsbidrag' },
  { number: '3920', name: 'Övriga bidrag', type: 'Intäkt', category: 'Statsbidrag' },
  { number: '4010', name: 'Inköp livsmedel', type: 'Kostnad', category: 'Kost' },
  { number: '5010', name: 'Lokalkostnader', type: 'Kostnad', category: 'Lokaler' },
  { number: '5020', name: 'Inventarier', type: 'Kostnad', category: 'Material' },
  { number: '6110', name: 'Kontorsmaterial', type: 'Kostnad', category: 'Material' },
  { number: '6210', name: 'Pedagogiskt material', type: 'Kostnad', category: 'Material' },
  { number: '7010', name: 'Löner pedagogisk personal', type: 'Kostnad', category: 'Personal' },
...
export function UtbildningskontoplanWorkspace({ module: mod, sectorSlug, settingsHref }: ModuleWorkspaceProps) {
      ...
      <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
        <DialogContent className="max-w-md">
          <DialogHeader>
            ...
            <DialogDescription>
              {editingAccount ? 'Uppdatera kontots uppgifter nedan.' : 'Fyll i uppgifterna för det nya kontot.'}
            </DialogDescription>
          </DialogHeader>
          <div className="grid gap-4 py-2">
            <div className="grid grid-cols-2 gap-4">
              <div className="grid gap-2">
                ...
                <Input id="acct-number" value={accountForm.number} onChange={(e) => setAccountForm((f) => ({ ...f, number: e.target.value }))} placeholder="3010" maxLength={6} disabled={!!editingAccount} />
              </div>
              <div className="grid gap-2">
                <Label htmlFor="acct-name">Kontonamn *</Label>
                <Input id="acct-name" value={accountForm.name} onChange={(e) => setAccountForm((f) => ({ ...f, name: e.target.value }))} placeholder="Kommunal peng" />
              </div>
            </div>
            <div className="grid grid-cols-2 gap-4">
              <div className="grid gap-2">
