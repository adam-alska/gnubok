...
type AccountCategory = 'Försäljning' | 'Frakt' | 'Returer' | 'Plattform' | 'Lager' | 'Moms' | 'Övrigt'
...
const ACCOUNT_CATEGORIES: AccountCategory[] = ['Försäljning', 'Frakt', 'Returer', 'Plattform', 'Lager', 'Moms', 'Övrigt']

const DEFAULT_ACCOUNTS: Account[] = [
  { number: '3001', name: 'Varuförsäljning', type: 'Intäkt', category: 'Försäljning' },
  { number: '3002', name: 'Försäljning tjänster', type: 'Intäkt', category: 'Försäljning' },
  { number: '3540', name: 'Fraktintäkt', type: 'Intäkt', category: 'Frakt' },
  { number: '3740', name: 'Öres- och kronutjämning / Returer', type: 'Kostnad', category: 'Returer' },
  { number: '4010', name: 'Inköp varor', type: 'Kostnad', category: 'Lager' },
  { number: '4990', name: 'Lagerförändring', type: 'Kostnad', category: 'Lager' },
  { number: '5710', name: 'Frakter och transporter', type: 'Kostnad', category: 'Frakt' },
  { number: '6590', name: 'Plattformsavgifter', type: 'Kostnad', category: 'Plattform' },
  { number: '6591', name: 'Shopify-avgifter', type: 'Kostnad', category: 'Plattform' },
  { number: '6592', name: 'Stripe-avgifter', type: 'Kostnad', category: 'Plattform' },
  { number: '6593', name: 'Klarna-avgifter', type: 'Kostnad', category: 'Plattform' },
  { number: '1460', name: 'Varulager', type: 'Tillgång', category: 'Lager' },
  { number: '2610', name: 'Utgående moms 25%', type: 'Skuld', category: 'Moms' },
  { number: '2620', name: 'Utgående moms 12%', type: 'Skuld', category: 'Moms' },
  { number: '2630', name: 'Utgående moms 6%', type: 'Skuld', category: 'Moms' },
]
...
export function EhandelskontoplanWorkspace({ module: mod, sectorSlug, settingsHref }: ModuleWorkspaceProps) {
              ...
              <EmptyModuleState
                ...
                description={
                  searchQuery || filterType !== 'all'
                    ...
                    : 'Lägg till konton för att bygga upp din e-handelskontoplan.'
                }
