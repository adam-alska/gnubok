...
export function LeverantorsfakturaImportButikWorkspace({ module, sectorSlug, settingsHref }: ModuleWorkspaceProps) {
  ...
  const loadImports = useCallback(async () => {
    ...
    const { data } = await supabase
      ...
      .eq('user_id', user.id).eq('sector_slug', sectorSlug).eq('module_slug', 'leverantorsfaktura-import-butik')
  ...
  async function handleConfirmImport() {
    ...
    await supabase.from('module_imports').insert({
      user_id: user.id, sector_slug: sectorSlug, module_slug: 'leverantorsfaktura-import-butik',
