...
type AccountCategory = 'Rum' | 'Konferens' | 'Mat & Dryck' | 'Spa' | 'Personal' | 'Lokal' | 'Ovrigt'
...
const ACCOUNT_CATEGORIES: AccountCategory[] = ['Rum', 'Konferens', 'Mat & Dryck', 'Spa', 'Personal', 'Lokal', 'Ovrigt']

const DEFAULT_ACCOUNTS: Account[] = [
  { number: '3010', name: 'Rumsintakter', type: 'Intakt', category: 'Rum' },
  { number: '3011', name: 'Svitintakter', type: 'Intakt', category: 'Rum' },
...
export function HotellkontoplanWorkspace({ module: mod, sectorSlug, settingsHref }: ModuleWorkspaceProps) {
  ...
  }, [accounts, filterType, filterCategory, searchQuery])
          ...
          <div className="space-y-6">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3">
              ...
              <Select
                ...
                onValueChange={(val) => setFilterCategory(val as AccountCategory | 'all')}
              >
                <SelectTrigger className="w-[180px]">
