...
const DEFAULT_ACCOUNTS: Account[] = [
  { number: '3010', name: 'Arvodesintäkter', type: 'Intäkt', category: 'Arvoden' },
  { number: '3011', name: 'Arvoden rättshjälp', type: 'Intäkt', category: 'Arvoden' },
  { number: '3012', name: 'Arvoden rådgivning', type: 'Intäkt', category: 'Arvoden' },
  { number: '1690', name: 'Klientmedelsfordran', type: 'Tillgång', category: 'Klientmedel' },
  { number: '2890', name: 'Klientmedelsskuld', type: 'Skuld', category: 'Klientmedel' },
  { number: '6990', name: 'Utlägg för klient', type: 'Kostnad', category: 'Utlägg' },
  { number: '6991', name: 'Domstolsavgifter', type: 'Kostnad', category: 'Utlägg' },
  { number: '6992', name: 'Registreringsavgifter', type: 'Kostnad', category: 'Utlägg' },
  { number: '7010', name: 'Löner jurister', type: 'Kostnad', category: 'Personal' },
  ...
  { number: '2420', name: 'Förskott från klienter', type: 'Skuld', category: 'Förskott' },
  { number: '1470', name: 'Pågående arbete', type: 'Tillgång', category: 'Arvoden' },
]
...
export function JuristkontoplanWorkspace({ module: mod, sectorSlug, settingsHref }: ModuleWorkspaceProps) {
