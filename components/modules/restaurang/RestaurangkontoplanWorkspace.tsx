...
type AccountCategory = 'Mat' | 'Dryck' | 'Alkohol' | 'Take-away' | 'Personal' | 'Lokal' | 'Övrigt'
...
const ACCOUNT_CATEGORIES: AccountCategory[] = ['Mat', 'Dryck', 'Alkohol', 'Take-away', 'Personal', 'Lokal', 'Övrigt']

const DEFAULT_ACCOUNTS: Account[] = [
  { number: '3001', name: 'Matförsäljning', type: 'Intäkt', category: 'Mat' },
  { number: '3002', name: 'Dryckesförsäljning', type: 'Intäkt', category: 'Dryck' },
  { number: '3003', name: 'Alkoholförsäljning', type: 'Intäkt', category: 'Alkohol' },
  { number: '3004', name: 'Take-away-försäljning', type: 'Intäkt', category: 'Take-away' },
  { number: '4010', name: 'Inköp livsmedel', type: 'Kostnad', category: 'Mat' },
  { number: '4020', name: 'Inköp dryck', type: 'Kostnad', category: 'Dryck' },
  { number: '4030', name: 'Inköp alkohol', type: 'Kostnad', category: 'Alkohol' },
...
export function RestaurangkontoplanWorkspace({ module: mod, sectorSlug, settingsHref }: ModuleWorkspaceProps) {
  ...
  async function handleSaveAccount() {
    ...
    if (editingAccount) {
      ...
      if (accounts.some((a) => a.number === newAccount.number)) {
        return // silently prevent duplicates
      }
