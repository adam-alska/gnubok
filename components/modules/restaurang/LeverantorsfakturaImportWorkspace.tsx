...
export function LeverantorsfakturaImportWorkspace({ module, sectorSlug, settingsHref }: ModuleWorkspaceProps) {
  ...
  const loadImports = useCallback(async () => {
    ...
    const { data } = await supabase
      ...
      .eq('module_slug', 'leverantorsfaktura-import')
  ...
  async function handleConfirmImport() {
    ...
    await supabase.from('module_imports').insert({
      ...
      module_slug: 'leverantorsfaktura-import',
      filename,
      status: 'completed',
          ...
          <TabsContent value="importera" className="space-y-6 mt-6">
            {!parsedData && !saved && (
              <ImportDropzone
                ...
                description="CSV eller Excel med kolumner: Datum, Leverant\u00f6r, Beskrivning, Belopp, Moms"
              />
            )}
          ...
          <TabsContent value="historik" className="mt-6">
            {loadingImports ? (
              ...
              <EmptyModuleState
                ...
                description="N\u00e4r du importerar leverant\u00f6rsfakturor visas de h\u00e4r."
              />
            ) : (
