...
export function ZrapportImportWorkspace({ module, sectorSlug, settingsHref }: ModuleWorkspaceProps) {
  ...
  const loadImports = useCallback(async () => {
    ...
    const { data } = await supabase
      ...
      .eq('module_slug', 'z-rapport-import')
          ...
          <TabsContent value="importera" className="space-y-6 mt-6">
            {!parsedData && !saved && (
              <ImportDropzone
                ...
                label="Dra och sl\u00e4pp din Z-rapport h\u00e4r"
                description="CSV eller Excel med kolumner: Datum, Total f\u00f6rs\u00e4ljning, Kontant, Kort, Swish, Moms 12%, Moms 25%"
              />
            )}
          ...
          <TabsContent value="historik" className="mt-6">
            {loadingImports ? (
              ...
              <EmptyModuleState
                ...
                description="N\u00e4r du importerar Z-rapporter visas de h\u00e4r."
              />
            ) : (
