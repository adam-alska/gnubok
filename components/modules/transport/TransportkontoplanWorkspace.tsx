...
type AccountCategory = 'Bränsle' | 'Leasing' | 'Underhåll' | 'Försäkring' | 'Avskrivning' | 'Fordon' | 'Trängselskatt' | 'Övrigt'
...
const ACCOUNT_CATEGORIES: AccountCategory[] = ['Bränsle', 'Leasing', 'Underhåll', 'Försäkring', 'Avskrivning', 'Fordon', 'Trängselskatt', 'Övrigt']

const DEFAULT_ACCOUNTS: Account[] = [
  { number: '3010', name: 'Transportintäkter', type: 'Intäkt', category: 'Övrigt' },
  { number: '3020', name: 'Fraktintäkter', type: 'Intäkt', category: 'Övrigt' },
  { number: '1240', name: 'Fordon', type: 'Tillgång', category: 'Fordon' },
  { number: '5610', name: 'Bränslekostnader', type: 'Kostnad', category: 'Bränsle' },
  { number: '5611', name: 'Underhåll fordon', type: 'Kostnad', category: 'Underhåll' },
  { number: '5612', name: 'Försäkringar fordon', type: 'Kostnad', category: 'Försäkring' },
  { number: '5615', name: 'Trängselskatt', type: 'Kostnad', category: 'Trängselskatt' },
  { number: '5620', name: 'Leasing fordon', type: 'Kostnad', category: 'Leasing' },
  { number: '7832', name: 'Avskrivning fordon', type: 'Kostnad', category: 'Avskrivning' },
]
...
export function TransportkontoplanWorkspace({ module: mod, sectorSlug, settingsHref }: ModuleWorkspaceProps) {
              ...
              <EmptyModuleState
                ...
                description={
                  searchQuery || filterType !== 'all'
                    ...
                    : 'Lägg till konton för att bygga upp din transportkontoplan.'
                }
