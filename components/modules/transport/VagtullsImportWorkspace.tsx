...
import { Upload, History, CheckCircle, Loader2, Receipt } from 'lucide-react'
...
export function VagtullsImportWorkspace({ module: mod, sectorSlug, settingsHref }: ModuleWorkspaceProps) {
          ...
          <TabsContent value="importera" className="space-y-6 mt-6">
            {!parsedData && !saved && (
              <ImportDropzone
                ...
                label="Dra och släpp fil från Transportstyrelsen här"
                description="CSV eller Excel med kolumner: Datum, Tid, Registreringsnummer, Betalstation, Belopp, Avgiftstyp"
              />
            )}
            ...
            {saved && (
              <div className="flex flex-col items-center gap-3 rounded-xl border border-emerald-500/20 bg-emerald-500/5 p-8">
                ...
                <p className="text-sm font-medium text-emerald-700">Importen är klar! Trängselskatt/vägtullar bokförs på konto 5615.</p>
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">
                      {parsedData.rows.length} rader hittades
                    </p>
                  </div>
                ...
                <div className="rounded-lg border border-amber-500/20 bg-amber-500/5 px-4 py-3">
                  ...
                  <p className="text-xs text-amber-700 mt-1">
                    Trängselskatt och vägtullar bokförs automatiskt per fordon på konto 5615.
                  </p>
                </div>
              </div>
            )}
          ...
          <TabsContent value="historik" className="mt-6">
            {loadingImports ? (
              ...
              <EmptyModuleState
                ...
                description="När du importerar filer från Transportstyrelsen visas de här."
              />
            ) : (
