...
type AccountCategory = 'Arbete' | 'Reservdelar' | 'Inköp' | 'Personal' | 'Lokal' | 'Övrigt'
...
const ACCOUNT_CATEGORIES: AccountCategory[] = ['Arbete', 'Reservdelar', 'Inköp', 'Personal', 'Lokal', 'Övrigt']

const DEFAULT_ACCOUNTS: Account[] = [
  { number: '3010', name: 'Arbetsintäkter', type: 'Intäkt', category: 'Arbete' },
  { number: '3020', name: 'Reservdelsförsäljning', type: 'Intäkt', category: 'Reservdelar' },
  { number: '3030', name: 'Besiktningsintäkter', type: 'Intäkt', category: 'Arbete' },
  { number: '4010', name: 'Inköp reservdelar', type: 'Kostnad', category: 'Inköp' },
  { number: '4020', name: 'Inköp förbrukningsmaterial', type: 'Kostnad', category: 'Inköp' },
  { number: '1460', name: 'Reservdelslager', type: 'Tillgång', category: 'Reservdelar' },
  { number: '5010', name: 'Lokalhyra verkstad', type: 'Kostnad', category: 'Lokal' },
  { number: '7010', name: 'Löner mekaniker', type: 'Kostnad', category: 'Personal' },
...
export function VerkstadskontoplanWorkspace({ module: mod, sectorSlug, settingsHref }: ModuleWorkspaceProps) {
  ...
  return (
    <>
      <ModuleWorkspaceShell title={mod.name} description={mod.desc} category="bokforing" sectorName="Fordon & Verkstad" backHref={`/m/${sectorSlug}`} settingsHref={settingsHref} actions={<Button onClick={openNew}><Plus className="mr-2 h-4 w-4" />Nytt konto</Button>}>
