...
type AccountCategory = 'Regionvård' | 'Patientavgift' | 'Försäkring' | 'Läkemedel' | 'Personal' | 'Lokal' | 'Utrustning' | 'Övrigt'
...
const ACCOUNT_CATEGORIES: AccountCategory[] = ['Regionvård', 'Patientavgift', 'Försäkring', 'Läkemedel', 'Personal', 'Lokal', 'Utrustning', 'Övrigt']

const DEFAULT_ACCOUNTS: Account[] = [
  { number: '3010', name: 'Regionersättning', type: 'Intäkt', category: 'Regionvård' },
  { number: '3020', name: 'Patientavgifter', type: 'Intäkt', category: 'Patientavgift' },
  { number: '3030', name: 'Försäkringsersättning', type: 'Intäkt', category: 'Försäkring' },
  { number: '3040', name: 'Privatbetalande patienter', type: 'Intäkt', category: 'Patientavgift' },
  { number: '3050', name: 'Vaccinationsintäkter', type: 'Intäkt', category: 'Regionvård' },
  { number: '4010', name: 'Läkemedelsinköp', type: 'Kostnad', category: 'Läkemedel' },
  { number: '4020', name: 'Förbrukningsmaterial', type: 'Kostnad', category: 'Utrustning' },
  { number: '4030', name: 'Laboratoriekostnader', type: 'Kostnad', category: 'Övrigt' },
  { number: '5010', name: 'Lokalhyra mottagning', type: 'Kostnad', category: 'Lokal' },
  { number: '7010', name: 'Löner vårdpersonal', type: 'Kostnad', category: 'Personal' },
  { number: '7510', name: 'Sociala avgifter', type: 'Kostnad', category: 'Personal' },
  { number: '1510', name: 'Kundfordringar region', type: 'Tillgång', category: 'Regionvård' },
  { number: '1520', name: 'Kundfordringar försäkringsbolag', type: 'Tillgång', category: 'Försäkring' },
  { number: '2440', name: 'Upplupna regionersättningar', type: 'Skuld', category: 'Regionvård' },
]
...
export function VardkontoplanWorkspace({ module: mod, sectorSlug, settingsHref }: ModuleWorkspaceProps) {
              ...
              <EmptyModuleState
                ...
                description={
                  searchQuery || filterType !== 'all'
                    ...
                    : 'Lägg till konton för att bygga upp din vårdkontoplan.'
                }
          ...
          <DialogHeader>
            ...
            <DialogDescription>
              {editingAccount
                ...
                : 'Fyll i uppgifterna för det nya vårdkontot.'}
            </DialogDescription>
          </DialogHeader>
